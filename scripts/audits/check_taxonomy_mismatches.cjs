// scripts/check_taxonomy_mismatches.cjs
const fs = require("fs");
...
const allowed = {
	industry: new Set(extractValues(taxonomyContent, "INDUSTRIES")),
	category: new Set(extractValues(taxonomyContent, "CATEGORIES")),
	employer: new Set(extractValues(taxonomyContent, "EMPLOYERS")),
	tools: new Set(extractValues(taxonomyContent, "TOOLS")),
};
