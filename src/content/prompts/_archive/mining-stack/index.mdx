---
title: "The Mining Stack"
category: "intake"
role: "Forensic Archaeologist"
input_type: "Raw Archive (PDF/Email)"
output_format: "Markdown Narrative"
system_instructions: "Extract high-density engineering narratives from raw project archives."
hack_pack_source: "AUDIO_PROTOCOL.md"
---

## Phase 1: The Identity Anchor (MANDATORY)

_Always run this first to ground the AI._
...
_Use this to generate the core 'Bubble' narrative._
...
_Use this to generate the 'Key Wins' section for `deck.md`._
...
_Use this to select which images to drag into the Bubble._
