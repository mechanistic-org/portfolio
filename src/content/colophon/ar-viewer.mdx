...
{/* <model-viewer src="/assets/neil-armstrong/model.glb" alt="Neil Armstrong" ar ar-modes="webxr scene-viewer quick-look" environment-image="/assets/moon_1k.hdr" shadow-intensity="1" camera-controls touch-action="pan-y"></model-viewer> */}

<div class="border border-yellow-500/50 bg-yellow-500/10 p-4 font-mono text-sm text-yellow-200">
