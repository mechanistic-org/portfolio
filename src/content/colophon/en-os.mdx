...
description: "Source material stays separate from the authored record. Human review establishes the account; repeatable generation and checks carry it into the public site. EN-OS explains that boundary, the earlier publication failures, and their correction."
icon: "cpu"
color: "green"
order: 0
---
...
AI assists with retrieval, organization, proposed interpretations, and software construction. I am responsible for the accepted account, attribution, and decision to publish. Confidential material stays behind its publication gate; public claims must be supportable without exposing client information.
...
These checks enforce specified integrity and consistency rules. A file hash identifies an artifact; it does not establish what the artifact means. Neither a passing build nor a matching hash replaces review of the evidence.
