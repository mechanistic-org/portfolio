---
description: "SGI Indy workstation (1992-93): pizza-box packaging that put 3D graphics on the desk — high-performance thermal design with no acoustic penalty."
category: computing
client: []
cyberspace:
  enable: true
