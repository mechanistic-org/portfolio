...
forensic_summary:
  ...
  STB caused thermal crisis (Smart Card Reader >55\xB0C) and sheet metal warpage risks.
  ...
  junction at 84\xB0C; Salvaged DEV build schedule despite vendor shutdowns; Assets transitioned
  to Xbox division."
gallery: []
