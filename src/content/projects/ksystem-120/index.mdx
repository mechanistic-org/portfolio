...
cyberspace:
  ...
  - data:
    ...
    title: Hammered Lid
    deck:
    - body: Sanmina Plant 4 delivered pilot build lids (PN 520-1066-00) that were 3mm too wide due to a weldment error.
      subtitle: ''
      title: The Crisis
  ...
  - data:
    ...
    - body: Thermal adhesive variations caused 20°C temperature spikes in the CPU.
      subtitle: ''
      title: The Crisis
    - body: Switched to Phase Change Material (PCM) and heavy spring-loaded clips (50psi) to guarantee contact.
      subtitle: ''
      title: The Fix
---
