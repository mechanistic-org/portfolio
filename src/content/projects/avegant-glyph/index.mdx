...
asset_bucket: main
bom:
- label: Ear Can Gimbal (420-0001)
  value: Aluminum A380 or ADC12
- label: Headband Spring (420-0002)
  value: Piano Wire - JIS G 3522 DIA 2.03mm
- label: Detent Spring (420-0003)
  value: 301 Stainless Steel, Full Hard
- label: Eyepiece Lens Carrier (420-0005)
  value: 6061-T6 Aluminum
- label: Eyepiece Collapse Rail (420-0006)
  value: 1215 Steel
- label: Optics Module Chassis (420-0009)
  value: Magnesium AZ-91D
- label: Gap Hider Shutter 1 - Right (420-0014)
  value: 304 Stainless Steel
- label: Gap Hider Shutter 1 - Left (420-0015)
  value: 304 Stainless Steel
- label: Button Plate - Right (420-0019)
  value: AL 6061-T6
- label: Center Button (420-0020)
  value: AL 6061-T6
- label: Button Plate - Left (420-0023)
  value: AL 6061-T6
- label: Mirror Hinge Pin (420-0033)
  value: 304 Stainless Steel
- label: Optics IPD Rail (420-0034)
  value: SUS (Stainless Steel)
- label: Headband Spring 160 (420-0043)
  value: Piano Wire 1.60mm
- label: Arm Inner - Right (425-0001)
  value: Polypropylene RTP 100 RF
- label: Ear Cover - Left (425-0002)
  value: PC - Sabic EXL 1112
- label: Outer Headband (425-0003)
  value: PC - Sabic EXL 1414
- label: Arm Inner - Left (425-0005)
  value: Polypropylene RTP 100 RF
- label: Ear Cover - Right (425-0006)
  value: PC - Sabic EXL 1112
- label: Bezel Ring - Right (425-0008)
  value: PC - Sabic EXL 1112
- label: Bezel Ring - Left (425-0009)
  value: PC - Sabic EXL 1112
- label: Ear Cover Bushing Inner - Right (425-0010)
  value: PC - Sabic EXL 1112
- label: IOB Back Housing - Right (425-0012)
  value: PC 20% GF - Iupilon GS2020MN1
- label: Audio Cavity - Right - Front (425-0016)
  value: PC/ABS CYCOLOY C2800 FR
- label: SIL Light Pipe (425-0026)
  value: Polycarbonate (Optically Clear)
- label: Eyepiece Release Button (425-0028)
  value: PC - Sabic EXL 1112
- label: Button Plate Backer - Left (425-0034)
  value: PC/ABS CYCOLOY C2800 FR
- label: Accessory Snap (425-0037)
  value: PC/ABS CYCOLOY C2800 FR
- label: Faceplate (425-0039)
  value: PC - Sabic EXL 1112
- label: Power Switch (425-0040)
  value: PC/ABS CYCOLOY C2800 FR
- label: Headband Inner Liner - Left (425-0049)
  value: PA12 Grilimid TR90 (Body) / TPR Empilon HT45 (Skin)
- label: IPD Slider Gap Hider (425-0052)
  value: PET Sheet
- label: Nose Piece Housing (425-0056)
  value: RTP 200 D Nylon 6/12
- label: Nose Pad (425-0069)
  value: PC Sabic EXL 1414T / Silicone Overmold
- label: IPD Slider Cap (425-0072)
  value: PC - Sabic EXL 1112
- label: HDMI Color Indicator (425-0077)
  value: PC/ABS CYCOLOY C2800 FR
- label: Nose Carriage (425-0079)
  value: Delrin 507 Black Acetal
- label: Eyepiece Can (425-0082)
  value: SABIC ULTEM 1010
- label: Boot - Left (427-0001)
  value: Liquid Silicone Rubber (LSR) Shore A 70
- label: Boot - Right (427-0002)
  value: Liquid Silicone Rubber (LSR) Shore A 70
- label: Eyepiece Dust Seal (427-0005)
  value: Felt, Black
- label: Illumination Mirror PSA (427-0009)
  value: 3M 55261 Double Coated Tape
- label: Speaker Driver Pad (427-0014)
  value: Silicone Foam HT-800
- label: Optics Chassis Pad (427-0016)
  value: Closed Cell Urethane Foam
- label: Acoustic Mesh (427-0017)
  value: Saati Acoustex B020HY
- label: Nosepiece Gel Insert (427-0018)
  value: LSR Shore A 50
- label: Ear Pad - Right Assembly (820-0028)
  value: Leather / Memory Foam
- label: Ear Pad - Left Assembly (820-0029)
  value: Leather / Memory Foam
- label: MCU Board (Main PCB) (GLF-200 / 20-0164)
  value: Rigid
- label: ITE Board (HDMI/Video) (GLF-201 / 20-0164)
  value: Rigid
- label: DPP Board (Left Eye) (GLF-202 / 20-0165)
  value: Rigid
- label: DPP Board (Right Eye) (GLF-203 / 20-0166)
  value: Rigid
- label: Battery Board (GLF-204)
  value: Rigid
- label: Coupon Board (GLF-205)
  value: Rigid
- label: Button Board Left (840-0008)
  value: Rigid
- label: Button Board Right (840-0009)
  value: Rigid
- label: Bluetooth Board (840-0001 / 175-0001)
  value: Rigid
- label: LED Board Left (840-0006)
  value: Rigid
- label: LED Board Right (840-0007)
  value: Rigid
- label: Serial Number Sticker (435-0001)
  value: Matte Silver PET
- label: Retail Sleeve (457-0009)
  value: 450g C1S SBS
- label: Foam Insert (457-0025)
  value: Foam
- label: Artwork File (710-0004)
  value: Digital File
- label: Compliance Label
  value: 'FCC ID: 2AFYN-AG101, IC: 20644-AG101'
- label: Screw - TF M1.6 x 6mm (467-0020)
  value: 1018 Steel
- label: Screw M1.6-0.35 x 3mm (467-0017)
  value: 1018 Steel
- label: Screw - TF M2 x 8.3mm (467-0022)
  value: 1018 Steel
- label: Battery
  value: Li-Ion (Springpower mentioned as module vendor)
- label: DMD Chip
  value: Texas Instruments DLP
- label: Lens Stack
  value: Projection/Collimation Lenses
cast:
- name: Edward Tang
  org: Avegant
  role: CEO / Co-Founder
- name: Allan Evans
  org: Avegant
  role: CTO / Co-Founder / Program Owner
- name: Yobie Benjamin
  org: Avegant
  role: COO / CSO
- name: Joerg Tewes
...
- name: Grant Martin
  org: Avegant
  role: Head of Marketing and Product Strategy
- name: Richard Kerris
  org: Avegant
...
- name: Misha (Michael) Young
  org: Avegant
  role: Mechanical Engineer / Project Manager
- name: Kevin King
  org: Avegant
  role: Technical Project Manager
- name: Alexander Goldis
  org: Avegant
  role: Mechanical Engineer
- name: Samuel Backes
  org: Avegant
  role: Mechanical Engineer / Design
- name: Corey Higham
  org: Avegant
  role: Mechanical Engineer / Drafter
- name: Leonard (Leo) Pang
  org: Avegant
...
- name: Emma Kessler
  org: Avegant
  role: Manager of Brand Marketing
- name: Stephanie Johnson
  org: Avegant
  role: Marketing
- name: Lawrence (Larry) Supan
  org: Avegant
  role: Operations
- name: Maha Parameswaran
  org: Avegant
  role: Quality Assurance (QA)
- name: Dante Nuno
  org: Avegant
  role: Director of Human Resources
- name: Nicole Crittendon
  org: Avegant
  role: Office Manager
- name: Tori Geiken
  org: Avegant
  role: Customer Feedback
- name: Andrew (Andy) Turk
  org: Avegant
  role: Team Member
- name: Azmat Ali
  org: Avegant
...
- name: Julie Ling
  org: Avegant
  role: Team Member
- name: Dierdre De Medeiros
  org: Avegant
  role: Team Member
- name: Tony Barnes
  org: Avegant
  role: Team Member
- name: Radius Product Development
  org: Radius Product Development
  role: CMF and Implementation Support
- name: Stephen Gould Corporation
  org: Stephen Gould Corporation
  role: Packaging Vendor
- name: Texas Instruments
  org: Texas Instruments
  role: Technology Partner (DLP)
- name: Ascendant Engineering Solutions (AES)
  org: Ascendant Engineering Solutions
  role: Engineering Partner
- name: Saline Lectronics
  org: Saline Lectronics
  role: PCBA Vendor
- name: Tekna
  org: Tekna
  role: Design / Prototyping Partner
- name: Scott McCurdy
  org: Freedom CAD
  role: Contact - PCB Layout
- name: Mike Garrett
  org: Streamline Circuits
  role: Contact - PCB Fab
- name: Kristine Galloway
  org: PalPilot
  role: Contact - PCB Layout
- name: Jinghong Qian
  org: PalPilot
  role: Contact - PCB Layout
- name: Western Rubber & Supply, Inc.
  org: Western Rubber & Supply, Inc.
  role: Custom Extrusions Vendor
- name: Diverse Optics
  org: Diverse Optics
  role: Optical Components Vendor
- name: Peter
  org: Malata
  role: Contact
- name: Kony
...
- name: Samuel Backes
  org: Backes Design
  role: Contract Design / Modeling (Pre-internal)
...
complexity_vector:
  ...
  - count: 12
    date: 2013-09
    phase: Concept (Optical Engine)
  - count: 45
    date: 2013-12
    phase: Proto (CES OBench)
  - count: 150
    date: 2015-08
    phase: EVT (Engineering Validation)
  - count: 287
    date: 2015-11
  ...
  process_density:
  - complexity_score: 8
    material: Stainless Steel 301 (3/4 Hard, Cold-Rolled)
    part_name: Headband Spring Strap
    steps:
    - Cold Rolling (1207 MPa)
    - Stamping
    - Bending Cycle Testing (76.5k cycles)
    - Fatigue Analysis (Strain-Life)
    - Clamping Force Calibration (7.5N)
  - complexity_score: 9
    material: Mixed (Glass, ZEONEX E48R, AL)
    part_name: Optical Engine Module
    steps:
    - DMD Inspection (Cleanroom O4)
    - Folding Mirror Paint/Tape Application
    - Lens Stacking (P Assembly)
    - Diopter Calibration (0-position)
    - Dust Seal Compression
    - V-CUT (PCB)
  - complexity_score: 6
    material: Polymer/Cable Assy
    part_name: Telescoping Arm Mechanism
    steps:
    - Molding (Inner Liner)
    - Cable Routing
    - Cycle Testing (3000 cycles)
    - Wear/Kink Inspection
    - Limit Stop Calibration
  supply_chain_nodes:
  - location: Ontario, NY, USA
    role: Prism Fabrication
    vendor: Optimax
  - location: Hsin Chu, Taiwan
    role: Passive Components (Resistors)
    vendor: Cyntec
  - location: Suzhou, China
    role: Power Chokes
    vendor: Cyntec
  - location: China
    role: FATP / Molding / Optical Assembly
    vendor: Intretech
  - location: Unknown
    role: Projection Lens Fab
    vendor: Lacroix Optics
  - location: Michigan, USA
    role: PCB Assembly (Proto)
    vendor: Saline Lectronics
  tooling_chain:
  - cost_impact: High
    lead_time_weeks: 4
    tool_name: Nosepiece Carriage
    type: Hard Tooling
    vendor: Intretech
  - cost_impact: Med
    lead_time_weeks: 2
    tool_name: Mirror Carrier B
    type: Hard Tooling
    vendor: Duch Group
  - cost_impact: High
    lead_time_weeks: 6
    tool_name: Inner Liner Tool
    type: Hard Tooling (Injection Mold)
    vendor: Unknown (China)
  - cost_impact: Med
    lead_time_weeks: 3
    tool_name: Diffuser Injection Mold
    type: Hard Tooling (Trial Run)
    vendor: Intretech
cyberspace:
  enable: true
  layout: linear
  ...
  - align: center
    ...
    id: details
    legacy_deck: []
    text: A forensic analysis of the Avegant Glyph (Vulcan) engineering failure, strictly
      correlating post-launch user complaints ("Voice of the Customer") with pre-production
      engineering logs ("Voice of the Process").
...
forensic_metrics:
  quotes: []
forensic_summary:
  intervention: Implementation of a rigorous 'Cleanroom' protocol and specific optical
    inspection stations (O4/O7). Engineers were forced to manually 'wipe DMD clean'
    under 20x magnification microscopes. A 'Blue dot' defect required investigating
    the diffuser injection molding process.
  result: Yield recovery was slow and painful. By Week 16, Cleanroom RTY crawled to
    70.97%, but total yield remained volatile, hitting 0.00% in Weeks 15 and 29.
  trigger: Catastrophic yield collapse in Mass Production. Total RTY (Rolling Throughput
    Yield) plummeted to 35.40% in Week 10. The optical engine was sieged by 'impurities'
    (dust/particles), specifically 91 units (41%) failing for DMD dust.
gallery: []
hxo_ready: false
hydration_status: full
industry: consumer_electronics
isomorphics:
- hardware_point: Microscopic dust and tape trimmings caused a catastrophic yield
    collapse, failing 41% of units by corrupting the optical engine's DMD projection
    path. Deployed Station O4 for manual 20x magnification wiping and substituted
    shedding blackout tape with painted folding mirrors.
  label: Physical Dirt/Noise
  principle: You cannot project high-fidelity clarity through a contaminated foundational
    medium.
  software_point: Unstructured Data / Hallucinations — In Agentic Workflows, input
    context must be sanitized (data painting) and rigorously evaluated by secondary
    supervisor agents (O4 inspection) before entering the prompt context to prevent
...
- date: 2013-09-27
  ...
  title: Lens Details Received from AES
- date: 2013-10-07
  description: Development
  title: Test Optical Bench (OBench) Design Started
- date: 2013-10-18
  description: Development
  title: CES Optical Bench Design Started
- date: 2013-11-04
  description: Development
  title: CAD Model sent to AMS for review
- date: 2013-11-26
  description: Testing
  title: Testing of Projector and Aux Boards Started
- date: 2013-12-19
  description: Prototype
  title: Assembly and testing of CES Prototypes Started
- date: 2014-01-06
  description: Milestone
  title: Avegant Glyph Debut at CES 2014
- date: 2014-01-22
  description: Milestone
  title: Kickstarter Campaign Ends ($1.5 Million raised)
- date: 2014-06-16
  description: Schedule
  title: Glyph 1.0 Project Official Start Date
- date: 2014-07-08
  description: Prototype
  title: Works-Like (WL) Prototype Phase Start
- date: 2014-07-15
  description: Prototype
  title: Looks-Like (LL) Prototype Phase Start
- date: 2014-08-28
  description: Milestone
  title: Looks-Like Prototypes Complete
- date: 2014-09-05
  description: Milestone
  title: Works-Like Prototypes Complete
- date: 2014-09-17
  description: Development
  title: Production Intent (PI) Prototype Design Tasks Start
- date: 2014-11-21
  description: Development
  title: System Level Tasks Start
- date: 2014-12-02
  description: Meeting
  title: 'Vendor Visit: Guangzhou (Ear pad/Audio)'
- date: 2014-12-04
  description: Meeting
  title: 'Vendor Visit: Yoku (Battery), YongYuLong (ME), OTI (LSR)'
- date: 2014-12-05
  description: Meeting
  title: Intretech Factory Tour & TDE Testing Introduction
- date: 2015-01-05
  description: Milestone
  title: Final Design Unveiled at CES 2015
- date: 2015-03-10
  description: Schedule
  title: Update and release project schedule to Intretech
- date: 2015-03-24
  description: Planning
  title: EVT EE PCBA build plan sent to Intretech
- date: 2015-05-08
  description: Milestone
  title: Tooling Kick Off (List sent to Intretech)
- date: 2015-05-20
  description: Development
  title: Software Design Tasks Complete (Target)
- date: 2015-06-24
  description: Meeting
  title: Erik Norris Interview/Meeting with Joerg Tewes & Allan Evans
- date: 2015-07-07
  description: Procurement
  title: EVT Unit Payment Verification (150pcs)
- date: 2015-08-04
  description: Planning
  title: Feedback on DVT Plan provided to Intretech
- date: 2015-09-01
  description: Documentation
  title: EE BOM 20150901 Issued
- date: 2015-11-06
  description: Planning
  title: Glyph 2.0 Roadmap Issued
- date: 2016-01-12
  description: Testing
  title: Audio Frequency Response Testing (Glyph 1 Digital)
- date: 2016-01-19
  description: Schedule
  title: Glyph 1.0 Project Finish Date
- date: 2016-02-04
  description: Development
  title: Inner Liner Tool Drawing Created (467-0029)
- date: 2016-02-29
  description: Meeting
  title: TI / Intretech Factory Visit (720p Program Analysis)
- date: 2016-03-29
  description: Testing
  title: Clamping Force Sensitivity Testing
- date: 2016-03-30
  description: Development
  title: Artwork Drawing Release (427-0031)
- date: 2016-05-19
  description: Development
  title: Faceplate Engineering Review
- date: 2016-08-30
  description: Development
  title: Sleeve Development
- date: 2016-09-02
  description: Development
  title: Retail Sleeve Drawing Created (457-0029)
- date: 2016-09-23
  description: Development
  title: Updated Graphics and Layout (Drawing 457-0009 Rev 10)
- date: 2016-12-11
  description: Marketing
  title: Oprah's Favorite Things Promotion
- date: 2017-02-28
  description: Administrative
  title: Avegant Alumni Group Created
title: Avegant Glyph
toolIcons: []
toolchain: []
tools:
