...
cyberspace:
  ...
  stickies:
    ...
    - align: center
      ...
      legacy_deck: []
      text:
        A forensic analysis of the Avegant Glyph (Vulcan) engineering failure, strictly
...
forensic_summary:
  intervention:
    Implementation of a rigorous 'Cleanroom' protocol and specific optical
  ...
  result:
    Yield recovery was slow and painful. By Week 16, Cleanroom RTY crawled to
    70.97%, but total yield remained volatile, hitting 0.00% in Weeks 15 and 29.
  trigger:
    Catastrophic yield collapse in Mass Production. Total RTY (Rolling Throughput
...
slug: avegant-glyph
stats: {}
tags: [SolidWorks, Consumer Electronics, Leadership, Wearable AR, Manufacturing]
targets:
  - main
teamSize: INT 77
theme: hyperspace
