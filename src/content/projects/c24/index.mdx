...
- label: 'Thermal — the "banana" defect'
  ...
  trigger: 'Pilot ABS side caps (P/N 9440-55165/166) warped up to 2.50 mm in the high-temp "Rubberized Soft Paint" cure — baked flat on wire racks, gravity sagged them through glass transition.'
...
- label: 'Supply chain — the top-panel "no-bid"'
  ...
  trigger: 'Mid-schedule the primary overseas vendor (Kwanta/VTech) no-bid the most complex part — the Top Panel (P/N 9420-55105) — whose dense welded standoffs blocked the automated CNC welder.'
...
- label: 'Serviceability — the headphone-jack fire drill'
  ...
  value: '2 h+ → <10 min'
  trigger: 'A 4.8% field-failure rate on the headphone jack, buried behind the front bolster — a simple repair meant a 2-hour chassis teardown.'
