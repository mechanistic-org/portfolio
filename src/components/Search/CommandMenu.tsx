...
const CommandMenu: React.FC = () => {
	...
	return createPortal(
		<div className="fixed inset-0 z-[100] flex items-start justify-center px-4 pt-[20vh]">
			...
			<div className="border-border bg-card animate-in fade-in zoom-in-95 relative w-full max-w-xl overflow-hidden rounded-xl border shadow-2xl duration-200">
				<div className="border-border flex items-center border-b px-4">
					...
					<input
						...
						className="placeholder:text-muted-foreground text-foreground flex-1 bg-transparent py-4 text-lg outline-none"
						value={query}
						onChange={(e) => {
					...
					/>
					<div className="text-muted-foreground border-border hidden items-center gap-1 rounded border px-1.5 py-0.5 text-xs sm:flex">
				...
				<div className="max-h-[60vh] overflow-y-auto p-2">
					{filteredItems.length === 0 ? (
						<div className="text-muted-foreground py-12 text-center text-sm">No results found.</div>
					) : (
				...
				<div className="border-border bg-muted/50 text-muted-foreground flex justify-between border-t px-4 py-2 text-xs">
					<span>
